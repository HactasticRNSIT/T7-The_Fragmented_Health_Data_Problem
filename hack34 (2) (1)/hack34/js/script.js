 ...
 * =========================================================
 */
let appointmentsState = JSON.parse(localStorage.getItem('medisight_appointments')) || [];
...
function submitAppointment() {
  ...
  const userProfile = JSON.parse(localStorage.getItem('medisight_userProfile')) || {};
  ...
  localStorage.setItem('medisight_appointments', JSON.stringify(appointmentsState));
